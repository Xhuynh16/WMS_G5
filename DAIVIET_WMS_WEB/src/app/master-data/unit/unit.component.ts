...
export class UnitComponent {
  ...
  exportExcel() {
    return this._service.exportExcelUnit(this.filter).subscribe((result: Blob) => {
  ...
  submitForm(): void {
    ...
    if (this.validateForm.valid) {
      if (this.edit) {
        this._service.updateUnit(this.validateForm.getRawValue()).subscribe({
          next: (data) => {
            this.search();
          },
          error: (response) => {
        ...
        this._service.createUnit(this.validateForm.getRawValue()).subscribe({
          next: (data) => {
            this.search();
          },
          error: (response) => {
