...
export class DropdownService {
  ...
  // loại phương tiện
  getAllVehicleType(params: any = {}, IsActive: boolean = true): Observable<any> {
  ...
  // Nhóm tài khoản
  getAllAccountGroup(params: any = {}, IsActive: boolean = true): Observable<any> {
    return this.commonService.get('AccountGroup/GetAll', {...params, IsActive});
  }
  // lái xe
  ...
  GetAllAccountPlanVisit(params: any = {}, IsActive: boolean = true): Observable<any> {
    return this.commonService.get('AccountPlanVisit/GetAll', {...params, IsActive});
  }
  ...
  // chủng loại sản phẩm
  getAllTypeProduct(params: any = {}, IsActive: boolean = true): Observable<any> {
    return this.commonService.get('XHTD/TypeProduct/GetAll', {...params, IsActive});
  }
}
